    ...
    <>
      ...
      >
        ...
        <div className="p-4">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <MessageCircle className={cn(
                  "h-6 w-6 transition-all group-hover:scale-110",
                  showComments ? "fill-primary text-primary" : "text-foreground"
                )} />
              </button>
          ...
          <button 
            onClick={() => setShowComments(!showComments)}
            className="text-sm text-muted-foreground mb-3 hover:text-foreground transition-colors"
          >
            {showComments ? "Hide comments" : `View all ${comments} comments`}
          </button>
          ...
          <div className={cn(
            ...
            <div className="pt-3 border-t border-border">
              <CommentsSection postId={id} compact />
            </div>
          </div>
